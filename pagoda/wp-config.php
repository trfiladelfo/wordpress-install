 ...
 * language support.
 */
define ('WPLANG', 'pt_BR');			//Para traduzir para português coloca pt_BR

/**
 * WordPress Method Download, defaults to FTP.
 * Change this to method download the plugin/theme WordPress.
 */
define('FS_METHOD', 'direct');		//Para desabilitar FTP e fazer do download direto
